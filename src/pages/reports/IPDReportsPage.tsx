...
const wardOccupancy = [
  { ward: "General Ward", total: 40, occupied: 32, available: 8, color: "#3B82F6" },
  { ward: "Private Rooms", total: 20, occupied: 18, available: 2, color: "#10B981" },
  { ward: "ICU", total: 10, occupied: 8, available: 2, color: "#EF4444" },
  { ward: "Pediatric", total: 15, occupied: 10, available: 5, color: "#F59E0B" },
  { ward: "Maternity", total: 12, occupied: 9, available: 3, color: "#8B5CF6" },
];
...
const patientStatus = [
  { status: "Stable", count: 52, color: "#10B981" },
  { status: "Under Observation", count: 18, color: "#F59E0B" },
  { status: "Critical", count: 5, color: "#EF4444" },
  { status: "Ready for Discharge", count: 12, color: "#3B82F6" },
];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">IPD Reports</h1>
          <p className="text-gray-500">Inpatient department analytics and bed management</p>
        </div>
          ...
          <CardContent className="p-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-green-600">-0.5 days from target</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Admitted now</p>
              </div>
            </div>
          </CardContent>
        </Card>
            ...
            {wardOccupancy.map((ward) => {
              ...
              return (
                <div key={ward.ward} className="p-4 bg-gray-50 rounded-lg">
                  <p className="font-medium text-gray-900 text-sm">{ward.ward}</p>
                  <div className="mt-2">
              ...
              <tbody className="divide-y divide-gray-100">
                {admissionsByDepartment.map((dept) => (
                  <tr key={dept.department} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 text-right text-gray-900">{dept.count}</td>
                    ...
                    <td className="px-4 py-3 text-right text-gray-900">{dept.avgStay} days</td>
                  </tr>
                ))}
              </tbody>
            </table>
              ...
              <tbody className="divide-y divide-gray-100">
                {recentDischarges.map((patient) => (
                  <tr key={patient.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 text-gray-900">{patient.ward}</td>
                    <td className="px-4 py-3 text-right text-gray-900">{patient.days} days</td>
