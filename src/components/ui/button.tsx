...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-95",
  {
    variants: {
      variant: {
        default: "bg-primary-600 text-on-ink hover:bg-primary-700 shadow-sm hover:shadow-md",
        secondary: "bg-slate-100 text-ink hover:bg-slate-200 border border-line",
        outline: "border border-line bg-paper hover:bg-slate-50 text-ink-muted hover:border-slate-400",
        ghost: "hover:bg-slate-100 text-ink-muted",
